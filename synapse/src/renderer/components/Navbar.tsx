...
export default function Navbar({ navItems, loading }: NavbarProps) {
  ...
  return (
    <>
      <Flex
        ...
        <Flex
          ...
          <Text
            ...
            <a href="/">Synapse</a>
            <a href = "https://github.com/Cognition-Labs/Synapse" target="_blank" rel="noopener noreferrer">
            </a>
          </Text>
      ...
      <Progress value={0} isIndeterminate={loading} size='xs' colorScheme='blue' position="fixed" top="50px" w="100%"
        sx={{
          '& > div:first-child': {
